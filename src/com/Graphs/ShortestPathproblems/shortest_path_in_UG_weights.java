...
public class shortest_path_in_UG_weights {
        ...
        public int[] shortestPath(int[][] edges,int n,int m ,int src) {
            ...
            //A dist array of size N initialised with infinity to indicate that initially all the nodes are untraversed.
            int dist[] = new int[n];
    ...
    public static void main(String[] args) {
        ...
        shortest_path_in_UG_weights obj = new shortest_path_in_UG_weights();
